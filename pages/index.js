    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-screen-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 print:grid-cols-1 print:gap-0">
          ...
          <div className="bg-white p-10 md:p-12 print:p-[1cm_1cm_1cm_1cm] shadow-xl print:shadow-none mx-auto print:mx-0" style={{ minWidth: '205mm', maxWidth: '100%', minHeight: '287mm', fontFamily: "'Times New Roman', Times, serif", fontSize: '13.5pt', lineHeight: '1.55', background: 'white' }}>
